...
namespace MicroShopping.WebUI.Filters
{
    public static class RoleDefinitions
    {
        ...
        public const string AdminAndBelow = "Regular,User Administrator,Auction Administrator,Finance Administrator";
        public const string GodAndBelow = "Regular,User Administrator,Auction Administrator,Finance Administrator,God";
